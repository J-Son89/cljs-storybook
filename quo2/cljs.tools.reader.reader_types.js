...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_8607 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_8607(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_8608 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_8608(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_8613 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_8613(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_8618 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_8618(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_8622 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_8622(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_8627 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_8627(reader);
}
});
...
var self__ = this;
var reader__$1 = this;
var c = (((self__.buf_pos < self__.buf_len))?(self__.buf[self__.buf_pos]):cljs.tools.reader.reader_types.read_char(self__.rdr));
...
var self__ = this;
var reader__$1 = this;
var c = (((self__.buf_pos < self__.buf_len))?(self__.buf[self__.buf_pos]):cljs.tools.reader.reader_types.peek_char(self__.rdr));
return cljs.tools.reader.impl.utils.char$.call(null,c);
}));
...
if(("\r" === ch)){
var c = cljs.tools.reader.reader_types.peek_char(rdr);
if(((("\f" === c)) || (("\n" === c)))){
...
var self__ = this;
var reader__$1 = this;
var temp__5735__auto__ = cljs.tools.reader.reader_types.read_char(self__.rdr);
...
var self__ = this;
var reader__$1 = this;
return cljs.tools.reader.reader_types.peek_char(self__.rdr);
}));
...
return cljs.tools.reader.reader_types.unread(self__.rdr,ch);
}));
...
var c = cljs.tools.reader.reader_types.read_char(rdr);
var s = (new goog.string.StringBuffer());
while(true){
if(cljs.tools.reader.impl.utils.newline_QMARK_.call(null,c)){
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(s);
} else {
var G__8648 = cljs.tools.reader.reader_types.read_char(rdr);
var G__8649 = s.append(c);
c = G__8648;
s = G__8649;
continue;
}
...
return ((1) === cljs.tools.reader.reader_types.get_column_number(rdr));
} else {
return null;
}
});
