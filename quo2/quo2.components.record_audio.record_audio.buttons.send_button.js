...
$CLJS.SHADOW_ENV.setLoaded("quo2.components.record_audio.record_audio.buttons.send_button.js");

goog.provide('quo2.components.record_audio.record_audio.buttons.send_button');
quo2.components.record_audio.record_audio.buttons.send_button.f_send_button = (function quo2$components$record_audio$record_audio$buttons$send_button$f_send_button(recording_QMARK_,ready_to_send_QMARK_,reviewing_audio_QMARK_,force_show_controls_QMARK_){
var opacity = react_native.reanimated.use_shared_value.call(null,(cljs.core.truth_(force_show_controls_QMARK_)?(1):(0)));
var translate_y = react_native.reanimated.use_shared_value.call(null,(cljs.core.truth_(force_show_controls_QMARK_)?(76):(20)));
var connector_opacity = react_native.reanimated.use_shared_value.call(null,(0));
var width = react_native.reanimated.use_shared_value.call(null,(12));
var height = react_native.reanimated.use_shared_value.call(null,(24));
var border_radius_first_half = react_native.reanimated.use_shared_value.call(null,(16));
var border_radius_second_half = react_native.reanimated.use_shared_value.call(null,(8));
var start_y_animation = (function (){
quo2.components.record_audio.record_audio.helpers.animate_linear_with_delay.call(null,translate_y,(12),(50),133.33);

quo2.components.record_audio.record_audio.helpers.animate_easing_with_delay.call(null,connector_opacity,(1),(0),93.33);

quo2.components.record_audio.record_audio.helpers.animate_easing_with_delay.call(null,width,(56),83.33,(80));

quo2.components.record_audio.record_audio.helpers.animate_easing_with_delay.call(null,height,(56),83.33,(80));
...
quo2.components.record_audio.record_audio.helpers.animate_linear.call(null,translate_y,(0),(100));

quo2.components.record_audio.record_audio.helpers.set_value.call(null,connector_opacity,(0));

quo2.components.record_audio.record_audio.helpers.set_value.call(null,width,(12));

quo2.components.record_audio.record_audio.helpers.set_value.call(null,height,(24));

quo2.components.record_audio.record_audio.helpers.set_value.call(null,border_radius_first_half,(16));

return quo2.components.record_audio.record_audio.helpers.set_value.call(null,border_radius_second_half,(8));
});
var fade_in_animation = (function (){
quo2.components.record_audio.record_audio.helpers.animate_linear.call(null,translate_y,(0),(200));
...
if(cljs.core.truth_(force_show_controls_QMARK_)){
} else {
quo2.components.record_audio.record_audio.helpers.animate_linear.call(null,translate_y,(cljs.core.truth_(cljs.core.deref.call(null,reviewing_audio_QMARK_))?(76):(20)),(200));
}
...
quo2.components.record_audio.record_audio.helpers.animate_linear_with_delay.call(null,translate_y,(20),(0),(200));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [react_native.reanimated.view,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),quo2.components.record_audio.record_audio.style.send_button_container.call(null,opacity)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [react_native.reanimated.view,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),quo2.components.record_audio.record_audio.style.send_button_connector.call(null,connector_opacity,width,height,border_radius_first_half,border_radius_second_half)], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [react_native.reanimated.view,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),quo2.components.record_audio.record_audio.style.send_button.call(null,translate_y,opacity),new cljs.core.Keyword(null,"pointer-events","pointer-events",-1053858853),new cljs.core.Keyword(null,"none","none",1333468478)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [quo2.components.icon.icon,new cljs.core.Keyword("i","arrow-up","i/arrow-up",-1363214578),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"color","color",1011675173),quo2.foundations.colors.white,new cljs.core.Keyword(null,"size","size",1098693007),(20),new cljs.core.Keyword(null,"container-style","container-style",-240535783),quo2.components.record_audio.record_audio.style.send_icon_container], null)], null)], null)], null);
});
Object.defineProperty(module.exports, "f_send_button", { enumerable: false, get: function() { return quo2.components.record_audio.record_audio.buttons.send_button.f_send_button; } });
//# sourceMappingURL=quo2.components.record_audio.record_audio.buttons.send_button.js.map
